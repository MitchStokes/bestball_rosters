...
import type { PlayerExposure } from '../../types';
...
export const ExposureCard: React.FC<ExposureCardProps> = ({ 
  ...
  const { player, rosterCount, exposurePercentage, averageADP } = exposure;
    ...
    >
      ...
      <div className="space-y-2">
        <div className="flex justify-between items-center text-sm">
          <span className="text-gray-600">Roster Count:</span>
